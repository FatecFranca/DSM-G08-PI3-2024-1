...
describe('GET /employees/:id', () => {
    ...
    it('should return 200 if pass id of existing employee and is authenticated as employee', () => __awaiter(void 0, void 0, void 0, function* () {
        const { body } = yield (0, supertest_1.default)(server_1.default)
            .get(`/employees/${employee._id}`)
            .set('Authorization', employee.bearerToken)
            .expect(200);
        const { expectedUser } = (0, expectedUserBodyFromUserEntity_1.expectedUserBodyFromUserEntity)(employee.user);
        expect(body).toEqual({
    ...
    it('should return 200 if pass id of existing employee and is authenticated as admin', () => __awaiter(void 0, void 0, void 0, function* () {
        const { body } = yield (0, supertest_1.default)(server_1.default)
            .get(`/employees/${employee._id}`)
    ...
    it('should return 403 if pass id of existing employee and is authenticated as user', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(server_1.default)
            .get(`/employees/${employee._id}`)
            .set('Authorization', user.bearerToken)
            .expect(403);
    }));
    it('should return 404 if pass id of non-existing employee and is correctly authenticated', () => __awaiter(void 0, void 0, void 0, function* () {
