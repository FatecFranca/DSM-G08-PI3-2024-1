...
describe('GET /chats/:chatId', () => {
    ...
    it('should return 404 if chat does not exist', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(server_1.default)
            .get(`/chats/${new mongoose_1.Types.ObjectId()}`)
            .set('Authorization', user.bearerToken)
            .expect(404);
    }));
    it('should return 403 if user is not in chat', () => __awaiter(void 0, void 0, void 0, function* () {
        const anotherUserToken = 'Bearer ' + (yield jsonwebtoken_1.default.sign({
