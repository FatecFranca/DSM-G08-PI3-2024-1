...
describe('POST /chats', () => {
    ...
    it('should return 201 and create chat with userId of authenticate user', () => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        const { body } = yield (0, supertest_1.default)(server_1.default)
            .post('/chats')
            .set('Authorization', user.bearerToken)
            .expect(201);
        const savedChat = yield ChatModel_1.chatModel.findById(body._id);
        expect(savedChat).toBeTruthy();
        expect(savedChat === null || savedChat === void 0 ? void 0 : savedChat.patient.toString()).toBe((_a = user.user._id) === null || _a === void 0 ? void 0 : _a.toString());
        expect(body.patient).toBe((_b = user.user._id) === null || _b === void 0 ? void 0 : _b.toString());
    }));
    ...
    it('should return 403 if user is authenticated as admin', () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(server_1.default)
            .post('/chats')
