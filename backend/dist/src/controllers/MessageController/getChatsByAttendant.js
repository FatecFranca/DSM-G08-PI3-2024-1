...
exports.getChatsByAttendant = void 0;
const ChatModel_1 = require("../../models/ChatModel");
const RoleEnum_1 = require("../../types/RoleEnum");
const AppError_1 = require("../../errors/AppError");
const getChatsByAttendant = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const payload = req.payload;
    if (!payload) {
        throw AppError_1.AppError.internalServerError('Missing payload in request');
    }
    const attendantId = req.params.attendantId;
    const chats = yield ChatModel_1.chatModel.find({ attendant: attendantId });
...
exports.getChatsByAttendant = getChatsByAttendant;
